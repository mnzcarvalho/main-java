...
public class Calculadora {
    ...
    public void imprimeDivisaoDeDoisNumeros(double num1, double num2) {
        if (num2 == 0) {
            System.out.println("Não existe divissão por zero.");
            return;
        }
        System.out.println(num1 / num2);
    ...
    public void alteraDoisNumeros(int numero1, int numero2){ //dois parâmetros que são variáveis int com escopo local
        numero1 = 99;
        numero2 = 33;
